    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li>
                    <a href="<?php echo base_url("admin/calendar")?>" class="dropdown-toggle no-arrow">
                ...
                <li>
                    <a href="https://dropways.github.io/deskapp-free-single-page-website-template/" target="_blank" class="dropdown-toggle no-arrow">
                        ...
                        <span class="mtext">Landing Page <img src="<?php echo base_url("public/admin/")?>vendors/images/coming-soon.png" alt="" width="25"></span>
                    </a>
                </li>
            </ul>
        </div>
